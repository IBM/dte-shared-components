...
//         let c, d, u;
//         try {
//           c = ct.getTimezone(tz.tzCode); // get the real data for the tzcode
//           d = c.dstOffsetStr.replace(":", ""); // strip the : for isodatetime lookups
//           u = c.utcOffsetStr.replace(":", ""); // strip the : for isodatetime lookups
//         } catch (err) {
...
const DateTimePicker = ({
  ...
  return (
    ...
    //           defaultValue={
    //             timezone || (getTimeZoneOffsetForDate(date) || {}).text
    //           }
    //         >
    //           <SelectItem
    //             disabled={true}
