...
(0, _react2.storiesOf)('FileUploader', module).addParameters({
  component: _FileUploader.default,
  subcomponents: {
    FileUploaderButton: _FileUploader.FileUploaderButton,
    FileUploaderSkeleton: _FileUploader2.default,
    FileUploaderItem: _FileUploaderItem.default,
    FileUploaderDropContainer: _FileUploaderDropContainer.default
  }
}).addDecorator(_addonKnobs.withKnobs).add('FileUploaderButton', function () {
