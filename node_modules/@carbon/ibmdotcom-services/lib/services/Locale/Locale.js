...
var LocaleAPI = /*#__PURE__*/function () {
  function LocaleAPI() {
    (0, _classCallCheck2.default)(this, LocaleAPI);
  }

  (0, _createClass2.default)(LocaleAPI, null, [{
    key: "clearCache",
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                cookie = _ipcinfoCookie.default.get();
                _context.next = 3;
                return this.getLang();
              ...
              case 18:
                 ...
                 */
                _lang = _windowOrGlobal.default.navigator.language;
                lc = _lang.split('-')[0];
              ...
              case 10:
                ...
                location = countries.filter(function (country) {
                  ...
                  if (htmlLang !== -1) {
                    ...
                    (_country$locale = country.locale).splice.apply(_country$locale, [0, country.locale.length].concat((0, _toConsumableArray2.default)(localeMatch)));
