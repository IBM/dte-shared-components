...
var AnalyticsAPI = /*#__PURE__*/function () {
  function AnalyticsAPI() {
    (0, _classCallCheck2.default)(this, AnalyticsAPI);
  }

  (0, _createClass2.default)(AnalyticsAPI, null, [{
    key: "registerEvent",
    ...
    value: function registerEvent(eventData) {
      if (_windowOrGlobal.default.ibmStats) {
        _windowOrGlobal.default.ibmStats.event(eventData);
      }
    }
    /**
    ...
    value: function initScrollTracker() {
      if (_scrollTracker) {
        ...
        _windowOrGlobal.default.addEventListener('scroll', function () {
          didScroll = true;
        });
        ...
        setInterval(function () {
          if (didScroll) {
            didScroll = false;
            curMarker = Math.floor(_windowOrGlobal.default.pageYOffset / trackingInterval);
            ...
            if (curMarker > trackedMarker) {
              ...
              fireEvent({
                ...
                executionPath: _windowOrGlobal.default.innerWidth,
                execPathReturnCode: _windowOrGlobal.default.innerHeight
              });
            }
          }
        }, 50);
    ...
    value: function initDynamicTabs() {
      ...
      _windowOrGlobal.default.document.addEventListener('tab-selected', function (evt) {
    ...
    value: function initModals() {
      ...
      _windowOrGlobal.default.document.addEventListener('modal-hidden', function (evt) {
        modalHide(evt.target.id, evt.detail.launchingElement.innerText);
      });

      var modalShow = this.triggerModalShow.bind(this);

      _windowOrGlobal.default.document.addEventListener('modal-shown', function (evt) {
