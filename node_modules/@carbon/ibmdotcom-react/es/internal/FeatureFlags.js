...
export var DDS_MASTHEAD_L1 = process.env.DDS_MASTHEAD_L1 === 'true' || DDS_FLAGS_ALL || false;
/**
...
export var DDS_SIMPLE_OVERVIEW = process.env.DDS_SIMPLE_OVERVIEW === 'true' || DDS_FLAGS_ALL || false;
/**
...
export var DDS_LOGO_GRID = process.env.DDS_LOGO_GRID === 'true' || DDS_FLAGS_ALL || false;
/**
 * This determines if the logo grid will be rendered or not
 *
 * @type {string | boolean}
