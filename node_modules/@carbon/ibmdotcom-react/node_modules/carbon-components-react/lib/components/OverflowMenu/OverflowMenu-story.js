...
(0, _react2.storiesOf)('OverflowMenu', module).addParameters({
  component: _OverflowMenu.default,
  subcomponents: {
    OverflowMenuItem: _OverflowMenuItem.default
  }
}).addDecorator(_addonKnobs.withKnobs).add('basic', (0, _storybookReadme.withReadme)(_README.default, function () {
