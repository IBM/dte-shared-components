...
var StoryContent = function StoryContent(_ref) {
  ...
  }, "Purpose and function"), /*#__PURE__*/React.createElement("p", {
    style: {
      lineHeight: '20px'
    }
  }, "The shell is perhaps the most crucial piece of any UI built with", /*#__PURE__*/React.createElement("a", {
  ...
  }, "Header responsive behavior"), /*#__PURE__*/React.createElement("p", {
    style: {
      lineHeight: '20px'
    }
  ...
  }, "Secondary navigation"), /*#__PURE__*/React.createElement("p", {
    style: {
      lineHeight: '20px'
    }
...
storiesOf('UI Shell', module).addParameters({
  subcomponents: {
    Content: Content,
    Header: Header,
...
}).add('Header Base', withReadme(readme, function () {
...
})).add('Header Base w/ SkipToContent', withReadme(readme, function () {
